...
def copy_static_resources():
    ...
    try:
        ...
        shutil.copytree(f"{third_party_files}/multi-qa-MiniLM-L6-cos-v1", f"{SOURCE_DIR}/test_data/static/multi-qa-MiniLM-L6-cos-v1", dirs_exist_ok=True)
        shutil.copytree(f"{third_party_files}/aac_dataset/", f"{SOURCE_DIR}/test_data/static", dirs_exist_ok=True)
        shutil.copytree(f"{third_party_files}/daily_dialog/", f"{SOURCE_DIR}/test_data/static", dirs_exist_ok=True)
